...
export default function Commands() {
  ...
  const runCommand = async () => {
    ...
    try {
      ...
      const snippet = String(out).slice(0, 200);
      ...
      <div className="bg-[#171429] p-6 rounded-2xl border border-purple-700/20 shadow-xl">
        ...
        {response && (
          <div className="mt-5 p-4 bg-black/30 rounded-xl border border-purple-700/30">
            ...
            <pre className="mt-3 text-gray-300 whitespace-pre-wrap max-h-60 overflow-auto">
              {response}
            </pre>
          </div>
        )}
          ...
          <div className="space-y-3 max-h-40 overflow-auto">
            ...
            {history
              ...
              .map((h, i) => (
                <div
                  key={i}
                  className="p-3 rounded-lg bg-black/20 border border-purple-800/20"
                >
